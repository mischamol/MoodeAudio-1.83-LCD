...
# you can place this files under /var/local/www/commandw/
# enable the lcd updater in moodeaudio under 'configure' -> 'Periphals' or currentsong.txt
# this file is replaced by a stub after every update, so keep a backup somewhere else
